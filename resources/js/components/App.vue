        ...
        <aside class="sidebar">
            ...
            <div class="sidebar__nav">
                ...
                <!-- keep your SVG -->
                    ...
                    <li v-if="can('showcategories')">
                        <router-link class="menu__item" :to="`/${lang}/dashboard/categories`">
                            <span class="menu__icon">
                <!-- keep your SVG -->
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 832 1024">
                                    <path fill="currentColor"
                            ...
                            <span class="menu__title">{{ __('variable.categories') }}</span>
                        </router-link>
                    </li>
                ...
                <!-- keep your SVG -->
                    ...
                    <li v-if="can('showprices')">
                        <router-link class="menu__item" :to="`/${lang}/dashboard/prices`">
                            <span class="menu__icon">
                <!-- keep your SVG -->
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 832 1024">
                                    <path fill="currentColor"
                            ...
                            <span class="menu__title">{{ __('variable.prices') }}</span>
                        </router-link>
                    </li>
                    <li v-if="can('showpreorders')">
                        <router-link class="menu__item" :to="`/${lang}/dashboard/preorders`">
                            <span class="menu__icon">
                <!-- keep your SVG -->
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 832 1024">
                                    <path fill="currentColor"
                            ...
                            <span class="menu__title">{{ __('variable.preorders') }}</span>
                        </router-link>
                    </li>
