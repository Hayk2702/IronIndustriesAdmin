                ...
                <div class="parent_card_pagination">
                    <div class="card">
                        <b-table
                            ...
                            :filter="filter"
                            @row-clicked="can('editcategories') ? showAddOrEditForm($event, 'edit') : ''"
                        >
                            <template #table-busy>
                            ...
                            <template v-if="!isLoading" #cell(actions)="row">
                                <a v-if="can('editcategories')" class="btn btn-inverse-warning p-1 a_position"
                                ...
                                <button v-if="can('deletecategories')" class="btn btn-danger p-1 a_position"
                    ...
                    <PaginationComponent v-if="Object.keys(categories).length > 0"
                                         :paginate="paginate"
                    ...
                    <template #modal-title>
                        <b-row>
                            <b-col sm="10" md="10" class="title_popup fs-15 lh-2">
                                {{ (addOrEdit === 'add' ? __(('variable.add')) : __(('variable.edit'))) + " " + __(('variable.categories')) }}
                            </b-col>
                        </b-row>
                    </template>
